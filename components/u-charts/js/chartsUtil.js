...
let chartsUtil = {
	getSampleData(){
		...
		var Data={
			...
			LineC:{categories:['巡更点1', '二师', '三师', '四师', '五师', '六师','七师', '八师', '九师', '十师', '十一师', '十二师', '十三师', '十四师'],series:[{name: '完成度',data:[35, 20, 25, 37, 14, 20,28,35, 20, 25, 37, 24, 20,28,]},]},
			...
			Pie:{series:[{ name: '巡更点1', data: 50 }, { name: '巡更点2', data: 30 }, { name: '巡更点3', data: 20 }, { name: '巡更点4', data: 18 }, { name: '巡更点5', data: 8 }]},
