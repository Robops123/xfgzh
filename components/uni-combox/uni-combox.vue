<template>
	<view class="uni-combox">
		...
		<view class="uni-combox__input-box">
			...
			<uni-icons class="uni-combox__input-arrow" color="#3f87ff" type="location-filled" size="14" @click="toggleSelector"></uni-icons>
		...
		computed: {
			...
			filterCandidates() {
				return this.candidates.filter((item) => {
					return item.address.indexOf(this.inputVal) > -1
				})
			},
